   ...
   return <div className="flow_container">
      ...
      <div className="flow_each">
         ...
         <div className="flow_each_right">
            ...
            <div className="description">Men always know how to have fun! :D</div>

            <div className="flow_body_content">
               <div className="flow_body_content_inner"> {/* 2 veya 4 varsa twoMedia yoksa threeMedia */}
                  {
                     mediaAr.map((el,idx)=>{
                        return <img key={idx} src="" alt="" className={`f${idx}`} />
                     })
                  }
                  {/* <video controls src={foto}></video> */}
               </div>
            ...
            <div className="flow_body_footer">
               <div className="flow_body_footer_left">
                  ...
                  <div className="repost">
                     ...
                     <span className="repost">2.3k</span>
                  </div>
                  <div className="like">
